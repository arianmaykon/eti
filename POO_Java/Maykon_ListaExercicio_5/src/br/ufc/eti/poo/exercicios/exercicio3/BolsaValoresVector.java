 ...
 */
public class BolsaValoresVector {

	private Vector <Acao> acoes;

	private InterBolsaValores view;

	public BolsaValoresVector(int qtdAcoes, InterBolsaValores view) {
		this.acoes = new Vector<Acao>(qtdAcoes);  
		this.view = view;
	}
